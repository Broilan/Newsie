  ...
  return (
    <div className=' bg-primary w-fit h-fit left-[25%] top-[25%] border-[2px] border-black rounded-[5px]'>
        ...
        <div className='w-[24rem] h-[30rem] bg-dimWhite shadow-2x1 border-none rounded-[5px] p-2'>
            <img src={image} className="w-[100%]  h-48 border-[2px] border-black " />
            ...
            <a href={url} className='flex border-2 ml-auto border-black justify-center mt-4 text-center p-1 pr-2 pt-1.5 rounded-[10px] h-10 w-20 bg-dimWhite text-primary font-semibold'> View </a>
            </div>
